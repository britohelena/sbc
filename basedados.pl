/*prato(nome,dieta,qualidade,custo,tipo,alergias)*/

prato('The Shawshank Redemption',1994,'9.3' ,[crime,drama],142,'Frank Darabont',['Tim Robbins', 'Morgan Freeman', 'Bob Gunton', 'William Sadler'],maior18).
