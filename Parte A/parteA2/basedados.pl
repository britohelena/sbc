:-dynamic(fact/1),[forward,proof].solucao
...
solucao(carnivora1):- versolucao(carnivora,entrada,gluten).
solucao(carnivora2):- versolucao(carnivora,entrada,lactose).
solucao(carnivora3):- versolucao(carnivora,entrada,nenhuma).
solucao(carnivora4):- versolucao(carnivora,principal,gluten).
solucao(carnivora5):- versolucao(carnivora,principal,lactose).
solucao(carnivora6):- versolucao(carnivora,principal,nenhuma).
solucao(carnivora7):- versolucao(carnivora,sobremesa,gluten).
solucao(carnivora8):- versolucao(carnivora,sobremesa,lactose).
solucao(carnivora9):- versolucao(carnivora,sobremesa,nenhuma).
solucao(vegetariana1):- versolucao(vegetariana,entrada,gluten).
solucao(vegetariana2):- versolucao(vegetariana,entrada,lactose).
solucao(vegetariana3):- versolucao(vegetariana,entrada,nenhuma).
solucao(vegetariana4):- versolucao(vegetariana,principal,gluten).
solucao(vegetariana5):- versolucao(vegetariana,principal,lactose).
solucao(vegetariana6):- versolucao(vegetariana,principal,nenhuma).
solucao(vegetariana7):- versolucao(vegetariana,sobremesa,gluten).
solucao(vegetariana8):- versolucao(vegetariana,sobremesa,lactose).
solucao(vegetariana9):- versolucao(vegetariana,sobremesa,nenhuma).
solucao(vegan1):- versolucao(vegan,entrada,gluten).
solucao(vegan2):- versolucao(vegan,entrada,lactose).
solucao(vegan3):- versolucao(vegan,entrada,nenhuma).
solucao(vegan4):- versolucao(vegan,principal,gluten).
solucao(vegan5):- versolucao(vegan,principal,lactose).
solucao(vegan6):- versolucao(vegan,principal,nenhuma).
solucao(vegan7):- versolucao(vegan,sobremesa,gluten).
solucao(vegan8):- versolucao(vegan,sobremesa,lactose).
solucao(vegan9):- versolucao(vegan,sobremesa,nenhuma).